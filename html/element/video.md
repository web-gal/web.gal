...
{{ htmlattrdef("src") }}
: The URL of the video to embed. This is optional; you may instead use the [`source`](/html/element/source/) element within the video block to specify the video to embed.
