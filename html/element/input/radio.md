...
There's not much new to note here except for the addition of [`fieldset`](/html/element/fieldset/) and [`legend`](/html/element/legend/) elements, which help to group the functionality nicely and in a semantic way.
